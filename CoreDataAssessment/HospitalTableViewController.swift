...
class HospitalTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let neededinfo = store.hospitals[indexPath.row]

        cell.textLabel!.text = neededinfo.name
        
        if let neededVetCount = neededinfo.vets?.count{
        
        cell.detailTextLabel!.text = String(neededVetCount)
